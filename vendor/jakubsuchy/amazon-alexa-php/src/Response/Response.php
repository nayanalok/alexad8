...
class Response {
  ...
  /**
   * Send Audio file for play
   * @param array $text
   * @return \Alexa\Response\Response
   */
  public function addAudio($text) {
    $this->audioItem = new AudioItem();
    $this->audioItem->title = $text['title'];
    $this->audioItem->url = $text['url'];
	...
	public function render() {
		return array(
			...
			'response' => array(
				...
				'directives' => $this->audioItem ? [$this->audioItem->render()] : null,
